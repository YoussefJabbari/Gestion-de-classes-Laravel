...
@section('content')
    <div class="clearfix content">
        ...
        <div class="clearfix single_content newsletter">
            <form action="{{ action('Enseignant\documentController@create', ['id' => $classe->id]) }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                        ...
                        @foreach($classe->documents as $document)
                            <div class="clearfix single_content">
                                ...
                                <div class="clearfix post_detail">
                                    ...
                                    <a href="{{ action('Enseignant\versionController@index',['idClasse'=>$classe->id,'idDocument'=>$document->id]) }}">Accéder au document</a>
                                </div>
                            </div>
